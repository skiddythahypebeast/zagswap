...
export const OrderErrorHandler = ({ reset, back }: { error: Error & { digest?: string }, reset: () => void, back: () => void }) => {
    return (
        <div className="w-[600px] max-w-[95%] h-[600px] px-20 flex flex-col gap-5 items-center justify-center text-text dark:text-dark-text">
            ...
            <div className="flex flex-row gap-2">
                <button onClick={back} className="border-primary dark:border-dark-primary bg-primary bg-opacity-20 dark:bg-dark-primary border-2 flex-1 rounded-md py-2 px-20">
                    <p className="font-medium text-primary dark:border-dark-primary">Back</p>
                </button>
