...
export const InputContainer = ({ children, position, size }: InputContainerProps) => {
    ...
    return (
        <div className={`${borderRadius} ${height} w-full bg-input dark:bg-dark-input shadow-inner shadow-shadow rounded-t-lg flex flex-row items-center justify-between overflow-clip`}>
            {children}
        </div>
    )
}