    ...
    return (
        <div className="z-50 inset-0 fixed">
            <div className="z-30 w-full h-full backdrop-blur-sm flex flex-row justify-end">
                <div className="py-10 shadow-2xl shadow-shadow dark:shadow-dark-shadow flex flex-col items-center justify-center relative xl:w-[600px] lg:w-[600px] md:w-[600px] w-full bg-bg1 dark:bg-dark-bg1">
